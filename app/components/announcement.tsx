...
const Announcement = () => {
  ...
  return (
    !close && (
      <div className="z-50 w-screen flex flex-col-reverse md:gap-0 gap-2 md:flex-row top-0 justify-evenly items-center fixed py-3 md:p-1.5 bg-white bg-opacity-[7%] backdrop-blur-md">
        ...
        <X
          onClick={closeHeader}
          className="self-end mr-4 md:self-auto md:mr-0 cursor-pointer"
          size="20"
          color="#BFBFBF"
        />
      </div>
