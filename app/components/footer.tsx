...
const Footer = () => {
  return (
    <footer className="max-w-screen dark:darkbg z-50 flex h-full min-h-full flex-col items-center justify-start gap-12 overflow-x-hidden bg-lightbg dark:bg-darkbg md:mx-0 md:justify-evenly">
      <div className="relative z-50 flex w-full max-w-3xl flex-col justify-start gap-y-8 border-t-2 border-t-lighthighlight bg-lightbg px-6 py-16 dark:border-t-darkhighlight dark:bg-darkbg md:flex-row md:justify-between md:gap-0 md:px-0  md:py-12">
        <div className="flex flex-col">
          <span className="flex flex-col font-serif text-xl text-lightheading dark:text-darkheading md:text-2xl">
            Wayfarers Space
          </span>
          <div className="flex flex-row items-center gap-4 py-2">
            <Link
              href="/x"
              className="font-serif text-lg text-lightheading hover:opacity-70 dark:hover:opacity-70  dark:text-darkheading md:text-xl"
            >
              <svg
                height="21"
                viewBox="0 0 20 21"
        ...
        <div className="flex flex-col">
          ...
          <Link
            ...
            className="font-serif text-lg text-lighttext hover:text-opacity-70 dark:text-darktext dark:hover:text-opacity-70 md:text-xl"
          >
            hi@wayfarers.space
          </Link>
        </div>
