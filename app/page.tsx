...
export default function Home() {
  return (
    <main className="bg-lightbg flex min-h-screen flex-col items-center overflow-x-hidden">
      <div className="mt-24 flex min-h-screen flex-col items-center justify-center md:mt-0 md:flex-row">
        <div className="sm:[350px] bg-lightbg mr-0 flex flex-col justify-center gap-4 bg-opacity-5 px-6 backdrop-blur-sm md:-mr-44 md:h-auto md:p-12 xl:w-[720px]">
          <h1 className="text-lighttitle font-head text-3xl md:text-4xl xl:text-6xl">
            Wayfarers Space
          </h1>
          <p className="md:text-md font-serif text-base text-lighttext xl:text-xl">
          ...
          <div className="flex flex-row gap-4">
            <Link
              href="/apply"
              className="md:text-md w-fit cursor-pointer rounded-full border-2 border-transparent bg-black  bg-opacity-[14%] px-4 py-1 font-serif text-base text-lightheading hover:border-black hover:border-opacity-[14%] hover:bg-transparent hover:text-lighttext md:px-10 xl:px-12 xl:text-xl"
            >
              Apply to Join
            </Link>
            <Link
              href="/discord"
              className="md:text-md w-fit cursor-pointer rounded-full border-2 border-black border-opacity-[14%] px-4 py-1 font-serif text-base text-lighttext hover:border-transparent hover:bg-black hover:bg-opacity-[14%] hover:text-lightheading md:px-10 xl:px-12 xl:text-xl"
            >
              Join Discord
            </Link>
          </div>
        </div>
        <div className="w-[300px] md:mt-0 md:w-[450px] xl:w-[600px]">
          <Image
