...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center overflow-x-hidden bg-darkdark">
      <div className="mt-24 flex min-h-screen flex-col items-center justify-center md:mt-0 md:flex-row">
        <div className="sm:[350px] mr-0 flex flex-col justify-center gap-4 bg-darkdark bg-opacity-5 px-6 backdrop-blur-sm md:-mr-44 md:h-auto md:p-12 xl:w-[720px]">
          <h1 className="font-head text-3xl text-darkheading md:text-4xl xl:text-6xl">
            Wayfarers Space
          </h1>
          <p className="md:text-md font-serif text-base text-darktext xl:text-xl">
          ...
          <div className="flex flex-row gap-4">
            <Link
              href="/apply"
              className="md:text-md w-fit cursor-pointer rounded-full border-2 border-transparent bg-white  bg-opacity-[14%] px-4 py-1 font-serif text-base text-darkheading2 hover:border-white hover:border-opacity-[14%] hover:bg-transparent hover:text-darktext md:px-10 xl:px-12 xl:text-xl"
            >
              Apply to Join
            </Link>
            <Link
              href="/discord"
              className="md:text-md w-fit cursor-pointer rounded-full border-2 border-white border-opacity-[14%] px-4 py-1 font-serif text-base text-darktext hover:border-transparent hover:bg-white hover:bg-opacity-[14%] hover:text-darkheading2 md:px-10 xl:px-12 xl:text-xl"
            >
              Join Discord
            </Link>
          </div>
